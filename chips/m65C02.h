...
/*#
    ...
    ***********************************
    ...
    ~~~C
    uint64_t m6510_iorq(m65C02_t* cpu, uint64_t pins)
    ~~~
...
uint64_t m6510_iorq(m65C02_t* c, uint64_t pins) {
...
uint64_t m65C02_tick(m65C02_t* c, uint64_t pins) {
    ...
    /* SLO zp (undoc) */
        ...
        case (0x07<<3)|3: c->AD=_m65C02_asl(c,c->AD);_SD(c->AD);c->A|=c->AD;_NZ(c->A);_WR();break;
    ...
    /* SLO abs (undoc) */
        ...
        case (0x0F<<3)|4: c->AD=_m65C02_asl(c,c->AD);_SD(c->AD);c->A|=c->AD;_NZ(c->A);_WR();break;
    ...
    /* ORA (zp) - 65C02 instruction */
		case (0x12 << 3) | 0: _SA(c->PC++); break;
		case (0x12 << 3) | 1: c->AD = _GD(); _SA(c->AD); break;
		case (0x12 << 3) | 2: _SA((c->AD + 1) & 0xFF); c->AD = _GD(); break;
		case (0x12 << 3) | 3: c->AD |= _GD() << 8; _SA((c->AD & 0xFF00) | ((c->AD) & 0xFF)); c->IR += (~((c->AD >> 8) - ((c->AD) >> 8))) & 1; break;
		case (0x12 << 3) | 4: _SA(c->AD); break;
		case (0x12 << 3) | 5: c->A |= _GD(); _NZ(c->A); _FETCH(); break;
    ...
    /* SLO (zp),Y (undoc) */
        ...
        case (0x13<<3)|6: c->AD=_m65C02_asl(c,c->AD);_SD(c->AD);c->A|=c->AD;_NZ(c->A);_WR();break;
    ...
    /* SLO zp,X (undoc) */
        ...
        case (0x17<<3)|4: c->AD=_m65C02_asl(c,c->AD);_SD(c->AD);c->A|=c->AD;_NZ(c->A);_WR();break;
    ...
    /* SLO abs,Y (undoc) */
        ...
        case (0x1B<<3)|5: c->AD=_m65C02_asl(c,c->AD);_SD(c->AD);c->A|=c->AD;_NZ(c->A);_WR();break;
    ...
    /* SLO abs,X (undoc) */
        ...
        case (0x1F<<3)|5: c->AD=_m65C02_asl(c,c->AD);_SD(c->AD);c->A|=c->AD;_NZ(c->A);_WR();break;
    ...
    /* RLA (zp,X) (undoc) */
        ...
        case (0x23<<3)|6: c->AD=_m65C02_rol(c,c->AD);_SD(c->AD);c->A&=c->AD;_NZ(c->A);_WR();break;
    ...
    /* RLA zp (undoc) */
        ...
        case (0x27<<3)|3: c->AD=_m65C02_rol(c,c->AD);_SD(c->AD);c->A&=c->AD;_NZ(c->A);_WR();break;
    ...
    /* RLA abs (undoc) */
        ...
        case (0x2F<<3)|4: c->AD=_m65C02_rol(c,c->AD);_SD(c->AD);c->A&=c->AD;_NZ(c->A);_WR();break;
    ...
    /* RLA (zp),Y (undoc) */
        ...
        case (0x33<<3)|6: c->AD=_m65C02_rol(c,c->AD);_SD(c->AD);c->A&=c->AD;_NZ(c->A);_WR();break;
    ...
    /* RLA zp,X (undoc) */
        ...
        case (0x37<<3)|4: c->AD=_m65C02_rol(c,c->AD);_SD(c->AD);c->A&=c->AD;_NZ(c->A);_WR();break;
    ...
    /* RLA abs,Y (undoc) */
        ...
        case (0x3B<<3)|5: c->AD=_m65C02_rol(c,c->AD);_SD(c->AD);c->A&=c->AD;_NZ(c->A);_WR();break;
    ...
    /* RLA abs,X (undoc) */
        ...
        case (0x3F<<3)|5: c->AD=_m65C02_rol(c,c->AD);_SD(c->AD);c->A&=c->AD;_NZ(c->A);_WR();break;
    ...
    /* SRE (zp,X) (undoc) */
        ...
        case (0x43<<3)|6: c->AD=_m65C02_lsr(c,c->AD);_SD(c->AD);c->A^=c->AD;_NZ(c->A);_WR();break;
    ...
    /* SRE zp (undoc) */
        ...
        case (0x47<<3)|3: c->AD=_m65C02_lsr(c,c->AD);_SD(c->AD);c->A^=c->AD;_NZ(c->A);_WR();break;
    ...
    /* ASR # (undoc) */
        ...
        case (0x4B<<3)|1: c->A&=_GD();c->A=_m65C02_lsr(c,c->A);_FETCH();break;
    ...
    /* SRE abs (undoc) */
        ...
        case (0x4F<<3)|4: c->AD=_m65C02_lsr(c,c->AD);_SD(c->AD);c->A^=c->AD;_NZ(c->A);_WR();break;
    ...
    /* EOR (zp) - 65C02 instruction */
		case (0x52 << 3) | 0: _SA(c->PC++); break;
		case (0x52 << 3) | 1: c->AD = _GD(); _SA(c->AD); break;
		case (0x52 << 3) | 2: _SA((c->AD + 1) & 0xFF); c->AD = _GD(); break;
		case (0x52 << 3) | 3: c->AD |= _GD() << 8; _SA((c->AD & 0xFF00) | ((c->AD) & 0xFF)); c->IR += (~((c->AD >> 8) - ((c->AD) >> 8))) & 1; break;
		case (0x52 << 3) | 4: _SA(c->AD); break;
		case (0x52 << 3) | 5: c->A ^= _GD(); _NZ(c->A); _FETCH(); break;
    ...
    /* SRE (zp),Y (undoc) */
        ...
        case (0x53<<3)|6: c->AD=_m65C02_lsr(c,c->AD);_SD(c->AD);c->A^=c->AD;_NZ(c->A);_WR();break;
    ...
    /* SRE zp,X (undoc) */
        ...
        case (0x57<<3)|4: c->AD=_m65C02_lsr(c,c->AD);_SD(c->AD);c->A^=c->AD;_NZ(c->A);_WR();break;
    ...
    /* SRE abs,Y (undoc) */
        ...
        case (0x5B<<3)|5: c->AD=_m65C02_lsr(c,c->AD);_SD(c->AD);c->A^=c->AD;_NZ(c->A);_WR();break;
    ...
    /* SRE abs,X (undoc) */
        ...
        case (0x5F<<3)|5: c->AD=_m65C02_lsr(c,c->AD);_SD(c->AD);c->A^=c->AD;_NZ(c->A);_WR();break;
    ...
    /* ADC (zp,X) */
        ...
        case (0x61<<3)|5: _m65C02_adc(c,_GD());_FETCH();break;
    ...
    /* ADC zp */
        ...
        case (0x65<<3)|2: _m65C02_adc(c,_GD());_FETCH();break;
    ...
    /* RRA zp (undoc) */
        ...
        case (0x67<<3)|3: c->AD=_m65C02_ror(c,c->AD);_SD(c->AD);_m65C02_adc(c,c->AD);_WR();break;
    ...
    /* ADC # */
        ...
        case (0x69<<3)|1: _m65C02_adc(c,_GD());_FETCH();break;
    ...
    /* ARR # (undoc) */
        ...
        case (0x6B<<3)|1: c->A&=_GD();_m65C02_arr(c);_FETCH();break;
    ...
    /* ADC abs */
        ...
        case (0x6D<<3)|3: _m65C02_adc(c,_GD());_FETCH();break;
    ...
    /* RRA abs (undoc) */
        ...
        case (0x6F<<3)|4: c->AD=_m65C02_ror(c,c->AD);_SD(c->AD);_m65C02_adc(c,c->AD);_WR();break;
    ...
    /* ADC zp,X */
        ...
        case (0x75<<3)|3: _m65C02_adc(c,_GD());_FETCH();break;
    ...
    /* RRA zp,X (undoc) */
        ...
        case (0x77<<3)|4: c->AD=_m65C02_ror(c,c->AD);_SD(c->AD);_m65C02_adc(c,c->AD);_WR();break;
    ...
    /* ADC abs,Y */
        ...
        case (0x79<<3)|4: _m65C02_adc(c,_GD());_FETCH();break;
    ...
    /* RRA abs,Y (undoc) */
        ...
        case (0x7B<<3)|5: c->AD=_m65C02_ror(c,c->AD);_SD(c->AD);_m65C02_adc(c,c->AD);_WR();break;
    ...
    /* ADC abs,X */
        ...
        case (0x7D<<3)|4: _m65C02_adc(c,_GD());_FETCH();break;
    ...
    /* STA (zp) - M65C02 instruction */
		case (0x92 << 3) | 0: _SA(c->PC++); break;
		case (0x92 << 3) | 1: c->AD = _GD(); _SA(c->AD); break;
		case (0x92 << 3) | 2: _SA((c->AD + 1) & 0xFF); c->AD = _GD(); break;
		case (0x92 << 3) | 3: c->AD |= _GD() << 8; _SA((c->AD & 0xFF00) | ((c->AD) & 0xFF)); break;
		case (0x92 << 3) | 4: _SA(c->AD); _SD(c->A); _WR(); break;
		case (0x92 << 3) | 5: _FETCH(); break;
    ...
    /* DCP (zp,X) (undoc) */
        ...
        case (0xC3<<3)|6: c->AD--;_NZ(c->AD);_SD(c->AD);_m65C02_cmp(c, c->A, c->AD);_WR();break;
    ...
    /* DCP zp (undoc) */
        ...
        case (0xC7<<3)|3: c->AD--;_NZ(c->AD);_SD(c->AD);_m65C02_cmp(c, c->A, c->AD);_WR();break;
    ...
    /* SBX # (undoc) */
        ...
        case (0xCB<<3)|1: _m65C02_sbx(c, _GD());_FETCH();break;
    ...
    /* DCP abs (undoc) */
        ...
        case (0xCF<<3)|4: c->AD--;_NZ(c->AD);_SD(c->AD);_m65C02_cmp(c, c->A, c->AD);_WR();break;
    ...
    /* DCP (zp),Y (undoc) */
        ...
        case (0xD3<<3)|6: c->AD--;_NZ(c->AD);_SD(c->AD);_m65C02_cmp(c, c->A, c->AD);_WR();break;
    ...
    /* DCP zp,X (undoc) */
        ...
        case (0xD7<<3)|4: c->AD--;_NZ(c->AD);_SD(c->AD);_m65C02_cmp(c, c->A, c->AD);_WR();break;
    ...
    /* DCP abs,Y (undoc) */
        ...
        case (0xDB<<3)|5: c->AD--;_NZ(c->AD);_SD(c->AD);_m65C02_cmp(c, c->A, c->AD);_WR();break;
    ...
    /* DCP abs,X (undoc) */
        ...
        case (0xDF<<3)|5: c->AD--;_NZ(c->AD);_SD(c->AD);_m65C02_cmp(c, c->A, c->AD);_WR();break;
    ...
    /* SBC (zp,X) */
        ...
        case (0xE1<<3)|5: _m65C02_sbc(c,_GD());_FETCH();break;
    ...
    /* ISB (zp,X) (undoc) */
        ...
        case (0xE3<<3)|6: c->AD++;_SD(c->AD);_m65C02_sbc(c,c->AD);_WR();break;
    ...
    /* SBC zp */
        ...
        case (0xE5<<3)|2: _m65C02_sbc(c,_GD());_FETCH();break;
    ...
    /* ISB zp (undoc) */
        ...
        case (0xE7<<3)|3: c->AD++;_SD(c->AD);_m65C02_sbc(c,c->AD);_WR();break;
    ...
    /* SBC # */
        ...
        case (0xE9<<3)|1: _m65C02_sbc(c,_GD());_FETCH();break;
    ...
    /* SBC # (undoc) */
        ...
        case (0xEB<<3)|1: _m65C02_sbc(c,_GD());_FETCH();break;
    ...
    /* SBC abs */
        ...
        case (0xED<<3)|3: _m65C02_sbc(c,_GD());_FETCH();break;
    ...
    /* ISB abs (undoc) */
        ...
        case (0xEF<<3)|4: c->AD++;_SD(c->AD);_m65C02_sbc(c,c->AD);_WR();break;
    ...
    /* SBC (zp),Y */
        ...
        case (0xF1<<3)|5: _m65C02_sbc(c,_GD());_FETCH();break;
        case (0xF1<<3)|6: assert(false);break;
        case (0xF1<<3)|7: assert(false);break;
    /* SBC (zp) - 65C02 instruction */
		case (0xF2 << 3) | 0: _SA(c->PC++); break;
		case (0xF2 << 3) | 1: c->AD = _GD(); _SA(c->AD); break;
		case (0xF2 << 3) | 2: _SA((c->AD + 1) & 0xFF); c->AD = _GD(); break;
		case (0xF2 << 3) | 3: c->AD |= _GD() << 8; _SA((c->AD & 0xFF00) | ((c->AD) & 0xFF)); c->IR += (~((c->AD >> 8) - ((c->AD) >> 8))) & 1; break;
		case (0xF2 << 3) | 4: _SA(c->AD); break;
		case (0xF2 << 3) | 5: _m65C02_sbc(c, _GD()); _FETCH(); break;
    ...
    /* ISB (zp),Y (undoc) */
        ...
        case (0xF3<<3)|6: c->AD++;_SD(c->AD);_m65C02_sbc(c,c->AD);_WR();break;
    ...
    /* SBC zp,X */
        ...
        case (0xF5<<3)|3: _m65C02_sbc(c,_GD());_FETCH();break;
    ...
    /* ISB zp,X (undoc) */
        ...
        case (0xF7<<3)|4: c->AD++;_SD(c->AD);_m65C02_sbc(c,c->AD);_WR();break;
    ...
    /* SBC abs,Y */
        ...
        case (0xF9<<3)|4: _m65C02_sbc(c,_GD());_FETCH();break;
    ...
    /* ISB abs,Y (undoc) */
        ...
        case (0xFB<<3)|5: c->AD++;_SD(c->AD);_m65C02_sbc(c,c->AD);_WR();break;
    ...
    /* SBC abs,X */
        ...
        case (0xFD<<3)|4: _m65C02_sbc(c,_GD());_FETCH();break;
    ...
    /* ISB abs,X (undoc) */
        ...
        case (0xFF<<3)|5: c->AD++;_SD(c->AD);_m65C02_sbc(c,c->AD);_WR();break;
